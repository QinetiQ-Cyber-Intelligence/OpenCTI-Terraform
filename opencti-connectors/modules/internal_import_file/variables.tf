...
################################
# -- OpenCTI Connector Stix -- #
################################

variable "in_imp_stix_connector_name" {
  type        = string
  description = "The name given to the Stix Internal Import connector."
}

variable "in_imp_stix_connector_image" {
  type        = string
  description = "The location on DockerHub of the Stix Internal Import connector."
}

####################################
# -- OpenCTI Connector Document -- #
####################################

variable "in_imp_document_connector_name" {
  type        = string
  description = "The name given to the Document Internal Import connector."
}

variable "in_imp_document_connector_image" {
  type        = string
  description = "The location on DockerHub of the Document Internal Import connector."
}